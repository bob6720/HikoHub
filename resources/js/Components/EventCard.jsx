...
export default function EventCard({event}){
    return(
        <div className="bg-black rounded shadow-md p-6 border border-gray-800 hover:shadow-lg transition-shadow duration-300">
            <a href={calendarLink(event)} target="_blank" rel="noopener noreferrer" className="mt-3 inline-block rounded-md bg-purple-600 px-3 py-2 text-white text-sm hover:bg-blue-700"> 
